...
| Quick demo | A generated audio sample — [listen here](samples/example.wav) (opens GitHub's built-in player) |
...
**Example output:**
Listen to a quick demo generated by the library:

▶ **[Listen to example output (WAV)](samples/example.wav)**

*(Click the link — GitHub's built-in audio player will open. The file is included in the repo under `samples/`.)*
