try:
    import onnxruntime
except ImportError:  # Allow dry-run without onnxruntime
    onnxruntime = None
import torch, random
import os
...
class SpeechTokenExtractor():
    def __init__(self, model_path):
        if onnxruntime is None:
            raise RuntimeError("onnxruntime is required for online feature extraction")
...
if onnx_path and onnxruntime is not None:
